    ...
    <nav className="sticky top-0 left-0 z-50 w-full bg-white dark:bg-neutral-800 border-b border-neutral-200 dark:border-neutral-900 py-3">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-5 text-sm text-neutral-600 dark:text-neutral-300">
          ...
          <Link
            href="https://www.pavsever.com/resume.pdf"
            target="_blank"
            download
        ...
        <div className="md:hidden">
          ...
          >
            {isOpen ? (
              ...
              <FiMenu size={26} className="text-neutral-800 dark:text-neutral-200" />
            )}
          </button>
        </div>
      </div>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-50 bg-white dark:bg-neutral-900 px-6 py-10 flex flex-col gap-6 text-lg text-neutral-800 dark:text-neutral-200 md:hidden"
          >
            <button
            ...
            <DropdownMenu mobile onClose={handleMobileMenuClose} />
            ...
            <ProfileMenu mobile onClose={handleMobileMenuClose} />
          </motion.div>
        )}
      </AnimatePresence>
    </nav>
